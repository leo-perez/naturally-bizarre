...
console.log(_colors2.default);

var Experiments = function () {
  function Experiments(title, description) {
    var _this = this;
    ...
    this.wrapper.addEventListener('dblclick', function () {
  ...
  _createClass(Experiments, [{
    ...
    value: function createWrapper() {
      ...
      var wrapperTitle = document.createElement('h2');
      var wrapperDescription = document.createElement('p');
    ...
    value: function createStats() {
      ...
      window.addEventListener('keydown', function (e) {
        switch (e.keyCode) {
          case 68:
            _this2.stats.domElement.style.display = _this2.stats.domElement.style.display === 'block' ? 'none' : 'block';
            break;
        }
      });
...
},{"../data/colors.json":302,"./Vector":301,"stats-js":299}],301:[function(require,module,exports){
"use strict";
...
var experiments = [_index2.default, _index4.default, _index6.default, _index8.default];
var experimentsNumber = location.hash ? parseInt(location.hash.replace('#', ''), 10) - 1 : 0;
var experimentsToggle = document.querySelectorAll('.js-experiment-toggle');

var experiment = new experiments[experimentsNumber]();

Array.from(experimentsToggle).forEach(function (link, index) {
...
},{"./experiments/1/index":305,"./experiments/2/index":307,"./experiments/3/index":309,"./experiments/4/index":310}],304:[function(require,module,exports){
'use strict';
...
},{"../../lib/random":312}],305:[function(require,module,exports){
'use strict';
...
var Experiment = function (_Experiments) {
  _inherits(Experiment, _Experiments);

  function Experiment() {
    _classCallCheck(this, Experiment);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Experiment).call(this, 'Root', 'Traditional random walk made by 2,500 walkers spread in the screen.'));

    _this.walkers = null;
    _this.walkersLength = 2500;
  ...
  _createClass(Experiment, [{
    ...
    value: function createWalkers() {
      ...
      for (var i = 0, length = this.walkersLength; i <= length; i++) {
        this.createWalker();
      }
    }
  }, {
    ...
    key: 'dblclick',
    value: function dblclick() {
      _get(Object.getPrototypeOf(Experiment.prototype), 'dblclick', this).call(this);
    ...
    key: 'resize',
    value: function resize() {
      _get(Object.getPrototypeOf(Experiment.prototype), 'resize', this).call(this);
...
},{"../../classes/Experiments":300,"../../lib/random":312,"./Walker":304}],306:[function(require,module,exports){
'use strict';
...
var Circle = function () {
    function Circle(radius, stroke, x, y) {
    ...
    _createClass(Circle, [{
        ...
        value: function move(x, y) {
            ...
            this.radius = (0, _lerp.lerp)(this.radius, 0, this.lerp);

            this.x = (0, _lerp.lerp)(this.x, x, this.lerp);
            this.y = (0, _lerp.lerp)(this.y, y, this.lerp);
...
},{"../../lib/lerp":311,"../../lib/random":312}],307:[function(require,module,exports){
'use strict';
...
var Experiment = function (_Experiments) {
  ...
  function Experiment() {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Experiment).call(this, 'Neon', 'Normal distribution of 500 circles with linear interpolation in position and radius.'));

    _this.circles = null;
    _this.circlesLength = 500;
  ...
  _createClass(Experiment, [{
    ...
    value: function createCircle() {
      ...
      var stroke = this.colors[this.circlesColor][(0, _random.randomInt)(0, this.colors.length - 1)];
      var x = this.mouse.x + (0, _random.randomNormalized)() * 200;
      var y = this.mouse.y + (0, _random.randomNormalized)() * 200;

      var circle = new _Circle2.default(radius, stroke, x, y);
    ...
    value: function createCircles() {
      ...
      for (var i = 0, length = this.circlesLength; i <= length; i++) {
        this.createCircle();
      }
    }
  }, {
...
},{"../../classes/Experiments":300,"../../lib/random":312,"./Circle":306}],308:[function(require,module,exports){
'use strict';
...
var Mover = function () {
  function Mover(radius, fill, location) {
    _classCallCheck(this, Mover);

    this.radius = radius;
    this.fill = fill;

    this.location = new _Vector2.default((0, _random.randomInt)(0, window.innerWidth), (0, _random.randomInt)(0, window.innerHeight));
  ...
  _createClass(Mover, [{
    ...
    value: function update(mouse, multiplier) {
      this.direction = _Vector2.default.sub(mouse, this.location);
...
},{"../../classes/Vector":301,"../../lib/random":312}],309:[function(require,module,exports){
'use strict';
...
var Experiment = function (_Experiments) {
  ...
  function Experiment() {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Experiment).call(this, 'Atom', 'Orbit of 500 circles using vectors of velocity and acceleration to define their position.'));

    _this.movers = null;
    _this.moversLength = 500;
    _this.moversColor = null;
    _this.moversMultiply = 0.75;
  ...
  _createClass(Experiment, [{
    ...
    value: function createMovers() {
      ...
      for (var i = 0, length = this.moversLength; i <= length; i++) {
        this.createMover(i);
      }
    }
  }, {
    ...
    value: function mousedown() {
      _get(Object.getPrototypeOf(Experiment.prototype), 'mousedown', this).call(this);
    ...
    value: function mouseup() {
      _get(Object.getPrototypeOf(Experiment.prototype), 'mouseup', this).call(this);
...
},{"../../classes/Experiments":300,"../../lib/random":312,"./Mover":308}],310:[function(require,module,exports){
'use strict';
...
var Experiment = function (_Experiments) {
  ...
  function Experiment() {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Experiment).call(this, 'Attraction', ''));
...
},{"../../classes/Experiments":300,"../../lib/random":312}],311:[function(require,module,exports){
"use strict";
