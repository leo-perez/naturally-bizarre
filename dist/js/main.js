...
var _randomInt = require('../lib/randomInt');
...
var Experiment = function (_Experiments) {
  ...
  function Experiment() {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Experiment).call(this));
  ...
  _createClass(Experiment, [{
    ...
    value: function createWalkers() {
      ...
      var colorSet = (0, _randomInt2.default)(0, 4);

      for (var i = 0, length = this.walkersLength; i <= length; i++) {
        var walker = new _walker2.default(COLORS[colorSet][(0, _randomInt2.default)(0, 3)], (0, _randomInt2.default)(0, window.innerWidth), (0, _randomInt2.default)(0, window.innerHeight));
    ...
    value: function click() {
      _get(Object.getPrototypeOf(Experiment.prototype), 'clear', this).call(this);
  ...
  return Experiment;
}(_experiments2.default);

exports.default = Experiment;

},{"../experiments":294,"../lib/randomInt":295,"./walker":293}],293:[function(require,module,exports){
'use strict';
...
var Walker = function () {
  ...
  _createClass(Walker, [{
    key: 'step',
    value: function step() {
      var random = (0, _randomInt2.default)(0, 3);
...
},{"../lib/randomInt":295}],294:[function(require,module,exports){
'use strict';
...
},{"stats-js":291}],295:[function(require,module,exports){
"use strict";
 ...
 */
var experiments = [_index2.default, _index2.default];

var experiment = new _index2.default();
var experimentToggle = document.querySelectorAll('.js-experiment-toggle');

Array.from(experimentToggle).forEach(function (link, index) {
