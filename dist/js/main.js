...
var Mover = function () {
  function Mover(radius, stroke, location, velocity) {
...
var Experiment = function (_Experiments) {
  ...
  _createClass(Experiment, [{
    ...
    value: function createMover(index) {
      ...
      var velocity = new _Vector2.default((0, _random.randomArbitrary)(-0.25, 0.25), (0, _random.randomArbitrary)(-0.25, 0.25));

      this.movers.push(new _Mover2.default(radius, color, location, velocity));
    }
  }, {
    key: 'createMovers',
...
},{"./Vector":299,"stats-js":291}],299:[function(require,module,exports){
"use strict";
