...
},{"./Vector":293,"stats-js":291}],293:[function(require,module,exports){
"use strict";
...
},{"./experiments/1/index":296,"./experiments/2/index":298,"./experiments/3/index":300,"./experiments/4/index":302}],295:[function(require,module,exports){
'use strict';
...
},{"../../lib/random":304}],296:[function(require,module,exports){
'use strict';
...
var TITLE = 'Root';
var DESCRIPTION = 'Traditional random walk made by 2,500 walkers spread in the screen.';
var COLORS = [['rgba(10, 215, 215, 0.2)', 'rgba(35, 40, 50, 0.2)', 'rgba(255, 45, 100, 0.2)', 'rgba(230, 230, 230, 0.2)'], ['rgba(255, 220, 0, 0.2)', 'rgba(245, 80, 140, 0.2)', 'rgba(160, 25, 165, 0.2)', 'rgba(70, 45, 70, 0.2)'], ['rgba(250, 85, 85, 0.2)', 'rgba(245, 250, 120, 0.2)', 'rgba(140, 235, 140, 0.2)', 'rgba(45, 125, 145, 0.2)'], ['rgba(0, 65, 130, 0.2)', 'rgba(15, 140, 240, 0.2)', 'rgba(250, 255, 165, 0.2)', 'rgba(255, 75, 105, 0.2)'], ['rgba(60, 30, 105, 0.2)', 'rgba(90, 60, 135, 0.2)', 'rgba(230, 90, 135, 0.2)', 'rgba(255, 170, 170, 0.2)']];
...
var Experiment = function (_Experiments) {
  ...
  function Experiment() {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Experiment).call(this, TITLE, DESCRIPTION));
  ...
  _createClass(Experiment, [{
    ...
    value: function createWalker() {
      var color = COLORS[this.walkersColor][(0, _random.randomInt)(0, 3)];
      var x = (0, _random.randomInt)(0, window.innerWidth);
      var y = (0, _random.randomInt)(0, window.innerHeight);

      this.walkers.push(new _Walker2.default(color, x, y));
    }
  }, {
    key: 'createWalkers',
    value: function createWalkers() {
      this.walkers = [];
      this.walkersColor = (0, _random.randomInt)(0, COLORS.length - 1);
...
},{"../../classes/Experiments":292,"../../lib/random":304,"./Walker":295}],297:[function(require,module,exports){
'use strict';
...
},{"../../lib/lerp":303,"../../lib/random":304}],298:[function(require,module,exports){
'use strict';
...
var TITLE = 'Neon';
var DESCRIPTION = 'Normal distribution of 500 circles with linear interpolation in position and radius.';
var COLORS = [['#0AD7D7', '#232832', '#FF2D64', '#E6E6E6'], ['#FFDC00', '#F5508C', '#9F19A4', '#462D46'], ['#FA5555', '#F5FA78', '#8CEB8C', '#2D7D91'], ['#004182', '#0E8CF0', '#FAFFA4', '#FF4B69'], ['#3C1E69', '#5A3C87', '#E65A87', '#FAA']];
...
var Experiment = function (_Experiments) {
  ...
  _createClass(Experiment, [{
    ...
    value: function createCircle() {
      ...
      var stroke = COLORS[this.circlesColor][(0, _random.randomInt)(0, COLORS.length - 1)];
      var x = this.mouse.x + (0, _random.randomNormalized)() * 200;
      var y = this.mouse.y + (0, _random.randomNormalized)() * 200;

      this.circles.push(new _Circle2.default(radius, stroke, x, y));
    }
  }, {
    key: 'destroyCircle',
    ...
    value: function createCircles() {
      this.circles = [];
      this.circlesColor = (0, _random.randomInt)(0, COLORS.length - 1);
...
},{"../../classes/Experiments":292,"../../lib/random":304,"./Circle":297}],299:[function(require,module,exports){
'use strict';
...
},{"../../classes/Vector":293,"../../lib/random":304}],300:[function(require,module,exports){
'use strict';
...
var TITLE = 'Atom';
var DESCRIPTION = 'Orbit of 500 circles using vectors of velocity and acceleration to define their position.';
var COLORS = [['#0AD7D7', '#232832', '#FF2D64', '#E6E6E6'], ['#FFDC00', '#F5508C', '#9F19A4', '#462D46'], ['#FA5555', '#F5FA78', '#8CEB8C', '#2D7D91'], ['#004182', '#0E8CF0', '#FAFFA4', '#FF4B69'], ['#3C1E69', '#5A3C87', '#E65A87', '#FAA']];
...
var Experiment = function (_Experiments) {
  ...
  _createClass(Experiment, [{
    ...
    value: function createMover(index) {
      ...
      var color = COLORS[this.moversColor][(0, _random.randomInt)(0, COLORS.length - 1)];

      this.movers.push(new _Mover2.default(radius, color));
    }
  }, {
    key: 'createMovers',
    value: function createMovers() {
      this.movers = [];
      this.moversColor = (0, _random.randomInt)(0, COLORS.length - 1);
...
},{"../../classes/Experiments":292,"../../lib/random":304,"./Mover":299}],301:[function(require,module,exports){
'use strict';
...
var Mover = function () {
  function Mover(stroke) {
    _classCallCheck(this, Mover);

    this.mass = (0, _random.randomArbitrary)(1, 10);

    this.radius = (0, _random.randomArbitrary)(1, 5);
    this.stroke = stroke;
  ...
  _createClass(Mover, [{
    ...
    value: function apply(force) {
      var v = _Vector2.default.div(force, this.mass);
...
},{"../../classes/Vector":293,"../../lib/random":304}],302:[function(require,module,exports){
'use strict';
...
var TITLE = 'Ping Pong';
var DESCRIPTION = 'Gravity applied to 500 circles with random mass.';
var COLORS = [['#0AD7D7', '#232832', '#FF2D64', '#E6E6E6'], ['#FFDC00', '#F5508C', '#9F19A4', '#462D46'], ['#FA5555', '#F5FA78', '#8CEB8C', '#2D7D91'], ['#004182', '#0E8CF0', '#FAFFA4', '#FF4B69'], ['#3C1E69', '#5A3C87', '#E65A87', '#FAA']];
...
var Experiment = function (_Experiments) {
  ...
  function Experiment() {
    ...
    _this.gravity = new _Vector2.default(0, 0.5);
    _this.wind = new _Vector2.default(0, 0);
  ...
  _createClass(Experiment, [{
    key: 'createMover',
    value: function createMover(index) {
      var radius = (0, _random.randomInt)(0, COLORS.length - 1);
      var color = COLORS[this.moversColor][(0, _random.randomInt)(0, COLORS.length - 1)];

      this.movers.push(new _Mover2.default(color));
    }
  }, {
    key: 'createMovers',
    value: function createMovers() {
    ...
    value: function update() {
      ...
      this.movers.forEach(function (mover, index) {
        ...
        mover.apply(_this2.wind);
        mover.apply(_this2.gravity);
        mover.update();
        mover.draw(_this2.context);
      });
    ...
    key: 'mousemove',
    value: function mousemove(e) {
      _get(Object.getPrototypeOf(Experiment.prototype), 'mousemove', this).call(this, e);
    }
  }, {
    key: 'mouseup',
    value: function mouseup() {
...
},{"../../classes/Experiments":292,"../../classes/Vector":293,"../../lib/random":304,"./Mover":301}],303:[function(require,module,exports){
"use strict";
