...
},{"../lib/random":299}],293:[function(require,module,exports){
'use strict';
...
var Experiment = function (_Experiments) {
  ...
  _createClass(Experiment, [{
    ...
    value: function createWalker(number) {
      var walker = new _Walker2.default(COLORS[number][(0, _random.randomInt)(0, 3)], (0, _random.randomInt)(0, window.innerWidth), (0, _random.randomInt)(0, window.innerHeight));
    ...
    value: function createWalkers() {
      ...
      var number = (0, _random.randomInt)(0, 4);
...
},{"../classes/Experiments":297,"../lib/random":299,"./Walker":292}],294:[function(require,module,exports){
'use strict';
...
},{"../lib/lerp":298,"../lib/random":299}],295:[function(require,module,exports){
'use strict';
...
var DESCRIPTION = 'Normal distribution of 250 circles with linear interpolation in position and radius.';
...
var Experiment = function (_Experiments) {
  ...
  _createClass(Experiment, [{
    ...
    value: function createCircle() {
      ...
      var color = COLORS[(0, _random.randomInt)(0, COLORS.length)];
      var x = this.x + (0, _random.randomNormalized)() * 175;
      var y = this.y + (0, _random.randomNormalized)() * 175;

      this.circles.push(new _Circle2.default(radius, '#000', color, x, y));
    }
  }, {
    key: 'destroyCircle',
...
},{"../classes/Experiments":297,"../lib/random":299,"./Circle.js":294}],296:[function(require,module,exports){
'use strict';
...
},{"../classes/Experiments":297,"../lib/random":299}],297:[function(require,module,exports){
'use strict';
...
},{"stats-js":291}],298:[function(require,module,exports){
"use strict";
