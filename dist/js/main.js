...
},{"../lib/random":301}],293:[function(require,module,exports){
'use strict';
...
var COLORS = [['rgba(10, 215, 215, .2)', 'rgba(35, 40, 50, .2)', 'rgba(255, 45, 100, .2)', 'rgba(230, 230, 230, .2)'], ['rgba(255, 220, 0, .2)', 'rgba(245, 80, 140, .2)', 'rgba(160, 25, 165, .2)', 'rgba(70, 45, 70, .2)'], ['rgba(250, 85, 85, .2)', 'rgba(245, 250, 120, .2)', 'rgba(140, 235, 140, .2)', 'rgba(45, 125, 145, .2)'], ['rgba(0, 65, 130, .2)', 'rgba(15, 140, 240, .2)', 'rgba(250, 255, 165, .2)', 'rgba(255, 75, 105, .2)'], ['rgba(60, 30, 105, .2)', 'rgba(90, 60, 135, .2)', 'rgba(230, 90, 135, .2)', 'rgba(255, 170, 170, .2)']];
...
var Experiment = function (_Experiments) {
  ...
  _createClass(Experiment, [{
    ...
    value: function click() {
      _get(Object.getPrototypeOf(Experiment.prototype), 'click', this).call(this);
...
},{"../classes/Experiments":298,"../lib/random":301,"./Walker":292}],294:[function(require,module,exports){
'use strict';
...
},{"../lib/lerp":300,"../lib/random":301}],295:[function(require,module,exports){
'use strict';
...
},{"../classes/Experiments":298,"../lib/random":301,"./Circle":294}],296:[function(require,module,exports){
'use strict';
...
var Mover = function () {
  function Mover(radius, stroke, location, velocity, acceleration) {
...
var TITLE = 'Gravity';
var DESCRIPTION = 'It\'s still under construction.';
var COLORS = [['#0AD7D7', '#232832', '#FF2D64', '#E6E6E6'], ['#FFDC00', '#F5508C', '#9F19A4', '#462D46'], ['#FA5555', '#F5FA78', '#8CEB8C', '#2D7D91'], ['#004182', '#0E8CF0', '#FAFFA4', '#FF4B69']];
...
var Experiment = function (_Experiments) {
  ...
  _createClass(Experiment, [{
    ...
    value: function createMover(index) {
      var radius = (0, _random.randomInt)(4, 22);
      var color = COLORS[this.moversColor][(0, _random.randomInt)(0, COLORS.length - 1)];
      var location = new _Vector2.default((0, _random.randomInt)(0, window.innerWidth), (0, _random.randomInt)(0, window.innerHeight));
      var velocity = new _Vector2.default(0, 0);
      var acceleration = new _Vector2.default(-0.001, 0.01);

      this.movers.push(new _Mover2.default(radius, color, location, velocity, acceleration));
    }
  }, {
    key: 'createMovers',
...
},{"../classes/Experiments":298,"../classes/Vector":299,"../lib/random":301,"./Mover":296}],298:[function(require,module,exports){
'use strict';
...
},{"stats-js":291}],299:[function(require,module,exports){
"use strict";
...
var _index = require('./experiment/1/index');

var _index2 = _interopRequireDefault(_index);

var _index3 = require('./experiment/2/index');

var _index4 = _interopRequireDefault(_index3);

var _index5 = require('./experiment/3/index');
...
var experiments = [_index2.default, _index4.default, _index6.default];
